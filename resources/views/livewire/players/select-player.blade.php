<div class="min-h-[400px]">
    @if($step === 'selection')
        ...
        @if(count($players) === 0)
            <div class="text-center py-10 bg-white rounded-3xl border-4 border-dashed border-purple-200">
                <p class="text-gray-400 font-bold text-xl">Aún no hay jugadores creados...</p>
                <p class="text-gray-400">¡Crea uno a la derecha! 👉</p>
            </div>
        @endif
